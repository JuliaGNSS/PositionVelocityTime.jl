...
@testset "calc_pvt with iono + tropo corrections" begin
    @testset "GPS L1 C/A — Klobuchar" begin
        ...
        @test PositionVelocityTime.select_ionospheric_correction(signal_groups(states)) isa
        ...
        pvt = calc_pvt(signal_groups(states); approximate_year = 2020)
